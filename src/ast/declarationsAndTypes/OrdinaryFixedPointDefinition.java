...
public class OrdinaryFixedPointDefinition extends AbstractAST implements AST {

    private Expression staticExpression;
    private RealRangeSpecification realRangeSpecification;

    public OrdinaryFixedPointDefinition(Expression staticExpression, RealRangeSpecification realRangeSpecification) {
	super();
